...
/**
 * CommercialDeliveryFormArticle
 *
 * @Table(name="COMMERCIAL_DELIVERY_FORM_ARTICLE")
 * @Entity
 */
class CommercialDeliveryFormArticle
{
    /**
     * @var boolean $isGroup
     *
     ...
     *
     * @ManyToOne(targetEntity="CommercialDeliveryForm")
     * @JoinColumns({
     *   @JoinColumn(name="delivery_form", referencedColumnName="id")
     * })
     */
    private $deliveryForm;

    /**
     * @var CommercialDeliveryFormArticle
     *
     * @ManyToOne(targetEntity="CommercialDeliveryFormArticle")
     * @JoinColumns({
     ...
     * @return CommercialDeliveryFormArticle
     */
     ...
     * @return CommercialDeliveryFormArticle
     */
    public function setDeliveryForm(\CommercialDeliveryForm $deliveryForm = null)
    {
     ...
     * Set parent
     *
     * @param CommercialDeliveryFormArticle $parent
     * @return CommercialDeliveryFormArticle
     */
    public function setParent(\CommercialDeliveryFormArticle $parent = null)
    {
        $this->parent = $parent;
        return $this;
    }
