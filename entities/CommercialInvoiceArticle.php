...
/**
 * CommercialInvoiceArticle
 *
 * @Table(name="COMMERCIAL_INVOICE_ARTICLE")
 * @Entity
 */
class CommercialInvoiceArticle
{
    /**
     * @var boolean $isGroup
     *
    ...
    /**
     * @var CommercialInvoiceArticle
     *
     * @ManyToOne(targetEntity="CommercialInvoiceArticle")
     * @JoinColumns({
     ...
     * @return CommercialInvoiceArticle
     */
     ...
     * Set parent
     *
     * @param CommercialInvoiceArticle $parent
     * @return CommercialInvoiceArticle
     */
    public function setParent(\CommercialInvoiceArticle $parent = null)
    {
        $this->parent = $parent;
        return $this;
    }
